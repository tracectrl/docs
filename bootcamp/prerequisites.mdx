...
The bootcamp uses **Gemma 4 31B** via Google AI Studio. It is completely free — no billing setup required.
...
<Frame>
  <img src="/images/google-ai-studio-rate-limits.png" alt="Gemini API Rate Limit page showing Gemma 4 31B free tier: 15 RPM, unlimited TPM, 1.5K RPD" />
</Frame>
...
python3 -c "from importlib.metadata import version; v = version('strands-agents')" 2>/dev/null \
