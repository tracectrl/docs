  ...
  <Step title="Choose your setup method">
    <Tabs>
      <Tab title="CLI Wizard (Recommended)">
        ...
        tracectrl setup
        ```
        {/* tracectrl pyproject has no extras_require — install plain `tracectrl`.
             Source: sdk/tracectrl/pyproject.toml (verified 2026-05). */}
...
<Steps>
  <Step title="Install the SDK">
    ...
    ```
    {/* PyPI verified 2026-05: tracectrl, tracectrl-instrumentation-strands,
         tracectrl-instrumentation-agno are published. Others source-only. */}
  </Step>
