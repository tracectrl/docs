...
| Framework | Package | Downloads | Status |
|-----------|---------|-----------|--------|
| Agno | `tracectrl-instrumentation-agno` | [![Downloads](https://img.shields.io/pypi/dm/tracectrl-instrumentation-agno?color=blue&label=)](https://pypistats.org/packages/tracectrl-instrumentation-agno) | Stable |
| AWS Strands | `tracectrl-instrumentation-strands` | [![Downloads](https://img.shields.io/pypi/dm/tracectrl-instrumentation-strands?color=blue&label=)](https://pypistats.org/packages/tracectrl-instrumentation-strands) | Stable |
